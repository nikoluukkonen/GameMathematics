Shader "Unlit/NewUnlitShader"
{
    Properties
    {
        ...
        _MaxHeight ("Max Height", Range(0.0, 100.0)) = 100.0
        _SnowHeight ("Snow Height", Range(0.0, 100.0)) = 100.0
        _MountainHeight ("Mountain Height", Range(0.0, 100.0)) = 100.0
        _WaterHeight ("Water Height", Range(-10.0, 100.0)) = 10.0
